...
export class LmsController {
  ...
  @Get('gradebook')
  @Permissions([AppPermission.LMS_GRADEBOOK_READ])
  ...
  @Put('gradebook/grade')
  @Permissions([AppPermission.LMS_GRADEBOOK_UPDATE])
  ...
  @Get('journal') @Permissions([AppPermission.LMS_JOURNAL_READ]) findJournalEntries() { return this.service.findJournalEntries(); }
  @Post('journal') @Permissions([AppPermission.LMS_JOURNAL_CREATE]) createJournalEntry(@Body() dto: CreateJournalEntryDto) { return this.service.createJournalEntry(dto); }
  @Patch('journal/:id') @Permissions([AppPermission.LMS_JOURNAL_UPDATE]) updateJournalEntry(@Param() p: UuidParamDto, @Body() dto: UpdateJournalEntryDto) { return this.service.updateJournalEntry(p.id, dto); }
  // Exam (Progress imtihonlar) endpointlari ExamController (exam.controller.ts) ga ko'chirildi.
  @Get('exam-results') @Permissions([AppPermission.LMS_EXAM_RESULTS_READ]) findExamResults() { return this.service.findExamResults(); }
  @Post('exam-results') @Permissions([AppPermission.LMS_EXAM_RESULTS_CREATE]) createExamResult(@Body() dto: CreateExamResultDto) { return this.service.createExamResult(dto); }
  @Patch('exam-results/:id') @Permissions([AppPermission.LMS_EXAM_RESULTS_UPDATE]) updateExamResult(@Param() p: UuidParamDto, @Body() dto: UpdateExamResultDto) { return this.service.updateExamResult(p.id, dto); }
}
