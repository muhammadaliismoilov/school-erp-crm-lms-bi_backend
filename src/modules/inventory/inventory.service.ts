...
export class InventoryService {
  ...
  findCategories() { return this.categories.find({ where: tenantWhere<InventoryCategory>(this.tenant, {}, { branch: true }), order: { createdAt: 'DESC' } }); }
  ...
  findItems() { return this.items.find({ where: tenantWhere<InventoryItem>(this.tenant, {}, { branch: true }), relations: { category: true, room: true }, order: { createdAt: 'DESC' } }); }
  ...
  findTransactions() { return this.transactions.find({ where: tenantWhere<InventoryTransaction>(this.tenant, {}, { branch: true }), relations: { item: true }, order: { createdAt: 'DESC' } }); }
