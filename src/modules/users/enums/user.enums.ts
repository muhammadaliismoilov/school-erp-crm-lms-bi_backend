...
export const userManagementRoleCandidates: Record<UserManagementRole, string[]> = {
  ...
  [UserManagementRole.SUPERMANAGER]: ['supermanager', 'super-manager', 'super-admin', 'director'],
};
