...
@Module({ imports: [TypeOrmModule.forFeature([StudentParent, AttendanceRecord, JournalEntry, ExamResult, Contract, Payment, MealMenu])], controllers: [MobilePortalController], providers: [MobilePortalService], exports: [MobilePortalService] })
